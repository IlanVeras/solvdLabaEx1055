...
let buttonBright = document.querySelector('#buttonBright')
...
function changeTheme(){
    ...
    if(theme){
        ...
        buttonBright.style.fill = '#A3ABB2'
        ...
        buttonBright.style.fill = '#3D3D3D'
...
function handleScroll(){
    console.log('teste')
    document.body.scrollTop = 0 //para quem usa safari
    window.scrollTo({
        top: 0,
        behavior: 'smooth'
    })
